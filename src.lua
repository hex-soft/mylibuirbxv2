...
function Library:create(options)
	...
	if readfile and writefile and isfile then
		if not isfile("MoonSettings.json") then
			writefile("MoonSettings.json", HTTPService:JSONEncode(settings))
		end
		settings = HTTPService:JSONDecode(readfile("MoonSettings.json"))
	...
	if getgenv and getgenv().MoonUI then
		getgenv():MoonUI()
		getgenv().MoonUI = nil
	end
	...
	creditsTab:credit{Name = "Repository", Description = "UI Library Repository", Github="https://github.com/deeeity/Moon-lib/blob/master/src.lua"}
