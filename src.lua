...
function Library:create(options)
	...
	creditsTab:credit{Name = "Abstract", Description = "UI Library Developer", Discord = "", V3rmillion = "AbstractPoo"}
	creditsTab:credit{Name = "Deity", Description = "UI Library Developer", Discord = "", V3rmillion = "0xDEITY"}
